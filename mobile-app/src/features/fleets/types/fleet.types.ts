...
export const GenderConstraintLabels: Record<GenderConstraint, string> = {
  [GenderConstraint.MALE_ONLY]: 'Homme only',
  [GenderConstraint.FEMALE_ONLY]: 'Femme only',
  [GenderConstraint.NO_CONSTRAINT]: 'Mixte',
};
